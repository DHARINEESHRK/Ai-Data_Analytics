...
export const MOCK_DATASETS: Dataset[] = [
  {
    ...
    quality: {
      ...
      column_type_breakdown: { numerical: 3, categorical: 2, datetime: 1, boolean: 1, text: 1 }
    },
    columns: [
      { name: 'customer_id', dtype: 'string', column_type: 'text', null_count: 0, null_percentage: 0.0, unique_count: 24850, sample_values: ['CUST-1049', 'CUST-2039', 'CUST-3940'] },
      { name: 'plan_tier', dtype: 'string', column_type: 'categorical', null_count: 0, null_percentage: 0.0, unique_count: 4, sample_values: ['Starter', 'Pro', 'Enterprise', 'Custom'], stats: { most_frequent: [{ value: 'Pro', count: 9850, percentage: 39.6 }, { value: 'Starter', count: 11440, percentage: 46.0 }] } },
      { name: 'monthly_spend', dtype: 'float', column_type: 'numerical', null_count: 12, null_percentage: 0.05, unique_count: 1540, sample_values: [49.00, 199.00, 1200.00], stats: { min: 29.00, max: 8500.00, mean: 420.50, median: 199.00, std: 680.20 } },
      { name: 'region', dtype: 'string', column_type: 'categorical', null_count: 0, null_percentage: 0.0, unique_count: 5, sample_values: ['North America', 'EMEA', 'APAC', 'LATAM'], stats: { most_frequent: [{ value: 'North America', count: 12400, percentage: 49.9 }, { value: 'EMEA', count: 6800, percentage: 27.4 }] } },
      { name: 'signup_date', dtype: 'datetime', column_type: 'datetime', null_count: 0, null_percentage: 0.0, unique_count: 890, sample_values: ['2023-01-15', '2023-06-20', '2024-02-10'], stats: { min_date: '2023-01-15', max_date: '2024-03-18' } },
      { name: 'churned', dtype: 'boolean', column_type: 'boolean', null_count: 0, null_percentage: 0.0, unique_count: 2, sample_values: [false, true], stats: { most_frequent: [{ value: 'false', count: 22100, percentage: 88.9 }, { value: 'true', count: 2750, percentage: 11.1 }] } },
      { name: 'nps_score', dtype: 'integer', column_type: 'numerical', null_count: 150, null_percentage: 0.6, unique_count: 11, sample_values: [9, 10, 7, 8], stats: { min: 1, max: 10, mean: 8.2, median: 9, std: 1.6 } },
      { name: 'support_tickets_count', dtype: 'integer', column_type: 'numerical', null_count: 0, null_percentage: 0.0, unique_count: 25, sample_values: [0, 2, 5, 1], stats: { min: 0, max: 34, mean: 2.1, median: 1, std: 3.2 } },
    ],
    preview_rows: [
  ...
  },
  {
    ...
    quality: {
      ...
      duplicate_rows: 0,
      duplicate_percentage: 0.0,
      column_type_breakdown: { numerical: 3, categorical: 2, datetime: 0, boolean: 0, text: 2 }
    },
    columns: [
      { name: 'order_id', dtype: 'string', column_type: 'text', null_count: 0, null_percentage: 0.0, unique_count: 51200, sample_values: ['ORD-9481', 'ORD-9482'] },
      { name: 'category', dtype: 'string', column_type: 'categorical', null_count: 0, null_percentage: 0.0, unique_count: 6, sample_values: ['Electronics', 'Furniture', 'Apparel'], stats: { most_frequent: [{ value: 'Electronics', count: 24000, percentage: 46.8 }] } },
      { name: 'sales_amount', dtype: 'float', column_type: 'numerical', null_count: 0, null_percentage: 0.0, unique_count: 4210, sample_values: [149.99, 899.00], stats: { min: 9.99, max: 4999.00, mean: 185.40, median: 89.50, std: 240.10 } },
      { name: 'discount_rate', dtype: 'float', column_type: 'numerical', null_count: 0, null_percentage: 0.0, unique_count: 10, sample_values: [0.05, 0.15, 0.00], stats: { min: 0.00, max: 0.40, mean: 0.08, median: 0.05, std: 0.06 } },
      { name: 'shipping_days', dtype: 'integer', column_type: 'numerical', null_count: 35, null_percentage: 0.07, unique_count: 14, sample_values: [2, 4, 1], stats: { min: 1, max: 18, mean: 3.4, median: 3, std: 1.8 } },
      { name: 'country', dtype: 'string', column_type: 'categorical', null_count: 0, null_percentage: 0.0, unique_count: 22, sample_values: ['United States', 'Germany', 'Japan'], stats: { most_frequent: [{ value: 'United States', count: 31000, percentage: 60.5 }] } },
      { name: 'payment_method', dtype: 'string', column_type: 'text', null_count: 0, null_percentage: 0.0, unique_count: 4, sample_values: ['Credit Card', 'Apple Pay', 'PayPal'] },
    ],
    preview_rows: [
